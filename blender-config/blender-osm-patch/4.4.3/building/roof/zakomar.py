...
from util.polygon import PolygonOLD as Polygon
...
class RoofZakomar(Roof):
    ...
    def make(self, osm):
        ...
        z1 = self.roofVerticalPosition # roof cornice # z1 = self.roofMinHeight   
        ...
        self.bottomIndices = [tuple(range(self.polygon.n)) ]
        
        #print("self.roofIndices", self.roofIndices)
        #print("self.wallIndices", self.wallIndices)
