...
print("we will load obj file " + strInputFileName)
print("current directory: " + WorkDir ) 

strObjectName=strInputFileName
if strObjectName[-4:len(strObjectName)] ==".obj":
...
#===============================================================
# import WAWEFRONT OBJ FILE
#===============================================================

bpy.ops.import_scene.obj(filepath=strInputFileName, use_split_objects=False, use_split_groups=False)
