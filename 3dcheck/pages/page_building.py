...
def page_building1(strQuadrantName, obj_rec, page_time_stamp, validation_errors, urlPrevious, urlNext):
    ...
    if obj_rec[23] == "True":   
                ...
                <div class="scene-container">
                    <div class="scene-header">
                        ...
                        <div class="controls">
                            ...
                            <button id="trigger-overlay" type="button">Osm2World</button>
        ...
        page += (f"""
                <div class="scene-container">
                    <div class="scene-header">
                        <h3>3D-модель здания -- отсутствует</h3>
                        
                    </div>
                    <div class="scene">
                    <!-- <img src="/data/building_images/'+obj_rec[28]+'.png"  height="512px" alt="3d Модель отсутствует" ><img> -->
                        <img src="/img/nomodel.gif"  alt="3d Модель отсутствует"><img> 
                    </div>    
                </div>""")
